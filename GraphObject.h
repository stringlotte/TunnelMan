...
class GraphObject
{
  public:
	...
	GraphObject(int imageID, int x, int y, Direction dir = right, double size = 1.0, unsigned int depth = 0)
	 : m_imageID(imageID), m_visible(false), m_x(x), m_y(y),
	   m_destX(x), m_destY(y), m_brightness(1.0),
